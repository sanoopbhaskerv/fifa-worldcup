...
export interface FantasyAuditRecord {
  ...
  tournamentId: string;
  actorId: string;
  action: "AI_SETTINGS_UPDATED" | "FIXTURE_UPDATED" | "PARTICIPANT_CREATED" | "PARTICIPANT_JOINED" | "PREDICTION_SUBMITTED" | "QUESTION_DRAFTS_SAVED" | "QUESTIONS_PUBLISHED" | "QUESTION_TEMPLATE_UPDATED" | "RESULT_SAVED" | "SCORES_PUBLISHED" | "SQUADS_IMPORTED" | "SQUAD_PLAYER_UPDATED" | "TEAM_UPDATED" | "TOURNAMENT_UPDATED";
